        ...
        const app = {
          ...
          songs: [
            {
              name: "Cầm",
              singer: "Có đâu ai ngờ",
              path: "./assets/music/song1.mp3",
              image: "./assets/img/song1.jpg"
            },
            {
              name: "Erik",
              singer: "Dịu dàng là ngày em đến",
              path: "./assets/music/song2.mp3",
              image: "./assets/img/song2.jpg"
            },
            {
              name: "DaLab,Phương Ly",
              singer: "Chạy khỏi thế giới này",
              path: "./assets/music/song3.mp3",
              image: "./assets/img/song3.jpg"
            },
            {
              name: "Winno",
              singer: "Tell Ur Mom II ",
      ...
      loadCurrentSong: function () {
        healding.textContent = this.currentSong.name;
